#
#  Be sure to run `pod spec lint AUISelectiveBordersView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "http://github.com/tastycode/AUISelectiveBordersView.git", :tag => "0.0.1" }
